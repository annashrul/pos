...
class M_laporan extends CI_Model{
	...
	function get_data_barang(){
		$hsl=$this->db->query("SELECT kategori_id,barang_id,kategori_nama,barang_nama,barang_satuan,barang_harpok,barang_stok FROM tbl_kategori JOIN tbl_barang ON kategori_id=barang_kategori_id GROUP BY kategori_id,barang_nama");
		return $hsl;
	}
	...
	function get_data_penjualan(){
		$hsl = $this->db->query("SELECT * FROM lap_data_penjualan");
		return $hsl;
	}
	...
	function get_total_penjualan(){
		$hsl = $this->db->query("SELECT * FROM lap_total_penjualan");
		return $hsl;
	}
